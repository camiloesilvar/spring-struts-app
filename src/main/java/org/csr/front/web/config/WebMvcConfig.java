package org.csr.front.web.config;
...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = { "org.csr.front.web.controller", "org.csr.back.usager" })
public class WebMvcConfig extends WebMvcConfigurerAdapter {
    ...
    public TilesConfigurer tilesConfigurer() {
    	logger.info("Configuration tiles ...");
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
    	logger.info("Configuration ressources ...");
